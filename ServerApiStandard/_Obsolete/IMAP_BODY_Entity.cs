    ...
    public class IMAP_BODY_Entity
    {
        ...
        internal void Parse(string text)
        {
            ...
            else
            {
                ...
                {
                    m_ContentSize = System.Convert.ToInt32(contentSize);
                }

                // Only for ContentType message/rfc822
                if (string.Equals(this.ContentType.TypeWithSubype, MIME_MediaTypes.Message.rfc822, System.StringComparison.InvariantCultureIgnoreCase))
                {
                    r.ReadToFirstChar();
                ...
                if (contentTypeMainMediaType.ToLower() == "text")
                {
                    ...
                    {
                        m_ContentLines = System.Convert.ToInt32(contentLines);
                    }
                }
            }
        }
        ...
        public int ContentSize
        {
            get
            {
                if (string.Equals(this.ContentType.Type, "multipart", System.StringComparison.InvariantCultureIgnoreCase))
                {
                    throw new System.Exception("NOTE: ContentSize property is available only for non-multipart contentype !");
                }
        ...
        public int ContentLines
        {
            get
            {
                if (!string.Equals(this.ContentType.Type, "text", System.StringComparison.InvariantCultureIgnoreCase))
                {
                    throw new System.Exception("NOTE: ContentLines property is available only for text/xxx content type !");
                }
